...
sumInc %>% 
  ...
  geom_hline(yintercept = 5.3, lty = 2, color = "pink") + 
  geom_vline(xintercept = 3.65, lty = 2, color = "pink") +
  theme_bw() +
...
sumInc %>% 
  ...
  geom_text(aes(label = c_alphan3)) + 
  geom_hline(yintercept = 5.3, lty = 2, color = "pink") + 
  geom_vline(xintercept = 3.61, lty = 2, color = "pink") +
  theme_bw() +
  ylab("Mean job satisfaction") + 
...
sumInc %>% 
  ...
  geom_text(aes(label = c_alphan3)) + 
  geom_hline(yintercept = 5.3, lty = 2, color = "pink") + 
  geom_vline(xintercept = 3.72, lty = 2, color = "pink") +
  theme_bw() +
  ylab("Mean job satisfaction") + 
  xlab("Mean quality of employee-management relations")
```
...
sumInc %>% 
  ...
  geom_text(aes(label = c_alphan3)) + 
  geom_hline(yintercept = 3.61, lty = 2, color = "pink") + 
  geom_vline(xintercept = 3.72, lty = 2, color = "pink") +
  theme_bw() +
...
sumInc %>% 
  ...
  geom_text(aes(label = c_alphan3)) + 
  geom_hline(yintercept = 5.3, lty = 2, color = "pink") + 
  geom_vline(xintercept = 3.95, lty = 2, color = "pink") +
  theme_bw() +
  ylab("Mean job satisfaction") + 
